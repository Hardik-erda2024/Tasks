...
const ht = require('./app/controller/htmlTask/controller');
...
router.get('/htmlTask1',passport.authenticate('jwt',{session:false}),ht.getHtmlTask1);
router.get('/htmlTask2',passport.authenticate('jwt',{session:false}),ht.getHtmlTask2);
router.get('/htmlTask3',passport.authenticate('jwt',{session:false}),ht.getHtmlTask3);
